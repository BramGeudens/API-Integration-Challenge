...
APIv4_key = "plaats hier uw apiv4 key" #api v4 token 
...
while True: # Het programma gaat door tot er een break komt.
    ...
    if Movie_name == "stop" or Movie_name == "s": # Wanneer de gebruiker een s of stop typt, gaat het programma afsluiten.
        ...
        if status_code == 200:
            ...
            print('status code ' + str(status_code) + 'Authentication failed')
        elif status_code == 500:
            print('status code ' + str(status_code) + 'Internal error')
        elif status_code == 501:
            print('status code ' + str(status_code) + 'Invalid service')
        else:
            print("Voor Staus Code: " + str(json_status) + "; Ga naar:")

            print("https://www.themoviedb.org/documentation/api/status-codes")
